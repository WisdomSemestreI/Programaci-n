...
SOURCEFILES_QUOTED_IF_SPACED=UART.c Uart_Uso.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/UART.p1 ${OBJECTDIR}/Uart_Uso.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/UART.p1.d ${OBJECTDIR}/Uart_Uso.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/UART.p1 ${OBJECTDIR}/Uart_Uso.p1

# Source Files
SOURCEFILES=UART.c Uart_Uso.c
...
${OBJECTDIR}/Uart_Uso.p1: Uart_Uso.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Uart_Uso.p1.d 
	@${RM} ${OBJECTDIR}/Uart_Uso.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1    -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/Uart_Uso.p1 Uart_Uso.c 
	@-${MV} ${OBJECTDIR}/Uart_Uso.d ${OBJECTDIR}/Uart_Uso.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/Uart_Uso.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
